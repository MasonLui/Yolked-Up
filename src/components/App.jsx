...
import ExerciseList from "./ExerciseList"; // Import the ExerciseList component
...
          className={`text-ripple py-2 px-4 rounded-lg transition-all duration-300 ${
            activeTab === "Articles" ? "bg-primary text-white" : "text-lightGray"
          }`}
        >
          Articles
        </button>
...
          className={`text-ripple py-2 px-4 rounded-lg transition-all duration-300 ${
            activeTab === "WorkoutLog" ? "bg-primary text-white" : "text-lightGray"
          }`}
        >
          Workout Log
        </button>
...
          className={`text-ripple py-2 px-4 rounded-lg transition-all duration-300 ${
            activeTab === "Profile" ? "bg-primary text-white" : "text-lightGray"
          }`}
        >
          Profile
        </button>
        <button
          id="tab-Exercises"
          onClick={(event) => handleTabClick(event, "Exercises")}
          className={`text-ripple py-2 px-4 rounded-lg transition-all duration-300 ${
            activeTab === "Exercises" ? "bg-primary text-white" : "text-lightGray"
          }`}
        >
          Exercises
        </button>
